...
<!--                         <a href="{{ url('logout') }}">
                    ...
                    <h2 style="font-family:'GothamRounded-Medium'; float: right;">Detail Surat, {{ session.get('nomor_surat')['nama_surat'] }}!</h2>
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Nama Surat</li>
                <li class="list-group-item">Jenis Surat</li>
                <li class="list-group-item">No Surat</li>
                <li class="list-group-item">Tanggal</li>
                <li class="list-group-item">Nama Pengupload</li>
